...
namespace EGH01DB
{
    ...
    public partial class RGEContext:IDBContext
    {
        ...
        public RGEContext(Controller controller)
        {
            this.controller = controller;
            this.listviewcontext = this.controller.Session["RGE.viewcontext"] as List<ViewContextEntry>;
            if (this.listviewcontext == null) this.controller.Session["RGE.viewcontext"] = this.listviewcontext = new List<ViewContextEntry>(); 
