...
namespace EGH01DB
{
    public class CAIContext : IDBContext
    {
        ...
        public CAIContext(Controller controller)
        {
            this.controller = controller;
            this.listviewcontext = this.controller.Session["CAI.viewcontext"] as List<ViewContextEntry>;
            if (this.listviewcontext == null) this.controller.Session["CAI.viewcontext"] = this.listviewcontext = new List<ViewContextEntry>();
