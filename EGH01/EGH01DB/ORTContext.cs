...
namespace EGH01DB
{
    public partial class ORTContext : IDBContext
    {
        ...
        SqlConnection con = DB.Connect("EGHORT");
        ...
        public ORTContext(Controller controller)
        {
            this.controller = controller;
            this.listviewcontext = this.controller.Session["ORT.viewcontext"] as List<ViewContextEntry>;
            if (this.listviewcontext == null) this.controller.Session["ORT.viewcontext"] = this.listviewcontext = new List<ViewContextEntry>();
