...
------------------------------------------
<<<<<<< HEAD
Adeln-25.11.2016 В отчет добавлены новые справочники 
=======
Adeln-25.11.2016 Таблицы для отчета выбор технологий реабилитации
>>>>>>> 180b9eeeacfc39250a1fdaba5623d52c6a376062
------------------------------------------
Adeln-20.11.2016 Форма отчета Сравнения с ПДК 
------------------------------------------
Adeln-17.11.2016-smw60: обновлен пример расчета. Изменения формула (8) для М1 
-------------------------------------------------------------------------------------------------------------
smw60-15.11.2016-AzarkevichO. 1)Оксана, я просил реальные данные по химсоставу. 
3) дииффузия  - не влезает разрядность (10^-7). 4) Оксана, следи за справочником там должны быть толко реальные данные !!! А не бардак 
4) заведи скрипт SQL-закгузки.
----------------------------------------------------------------------------------------------------------------
DaryaCherniak-15.11.2016-smw60,Adeln- EcoObject- готов отображающий список и создание природоохраняемых объектов. Прогноз-> Природоохранемые объекты
----------------------------------------------------------------------------------------------------------------
smw60-12.11.2016-Adeln - опорные точки не работают - не отображется список - подойдите ко мне кто писал 
-------------------------------------------------------------------------------------------------------------------
smw60-12.11.2016-DaryaCherniak - исправил ошибку в техногенных объектах для ввода типа грунтов, остальные справочники исп. в форме допиши сама по аналогии
------------------------------------------------------------------------------------------------------------------
AzarkevichO-13.11.2016 Справочник по воде готов - WaterProperties
------------------------------------------------------------------------------------------------------------------
Adeln 13.11.2016-smw60: исправленный и дополненный пример расчета2
----------------------------------------------------------------------------------
DaryaCherniak-13.11.2016-smw60,Adeln- как все же делать, ставить в типах грунтах большое количсетво знаков после запятой или домнажать на 10 в степени?
------------------------------------------------------------------------------------------------------------------
AzarkevichO-13.11.2016 - smw60, что именно не работает? потому что я могу все изменять
---
smw60-12.11.2016-Adeln,AzarkevichO: хим. состав  изменение - не работает!!!!
------------------------------------------------------------------------------------------------------------------
Adeln 12.11.2016-smw60: мелкие правки в порядке расчета
-----------------------------------------------------------------------
Adeln 11.11.2016-Отчет: обновление GroundType и PetrochemicalType
------------------------------------------------------------------------------------------------------------------
Adeln 11.11.2016-smw60: добавлен порядок расчкета
-----------------------------------------------------------------------------------------------------------------------
smw60-10.11.2016-Adeln: кто делает справочник по воде - нужен
-----------------------------------------------------------------------------------------------------------------------
smw60-10.11.2016-Adeln, AzarkevichO: очень нужны реальные данные по грунтам!!! 
------------------------------------------------------------------------------------------------------------------------
smw60-10.11.2016-Adeln, AzarkevichO: очень нужны реальные данные по хим составу нефтей!!!  и воде  не могу проверить ничено
-------------------------------------------------------------------------------------------------------------------
smw60-10.11.2016-Adeln,DaryaCherniak,BlinovaE : в справочнике ПДК уберите УДАЛИТЬ, разбиретесь с точностью вводимых данных (например не могу ввести ПДК = 0.3), 
кроме того должно быть поле  для ввода ссылки на документ  с ПДК    
-------------------------------------------------------------------------------------------------------------------
smw60-10.11.2016-BlinovaE в RiskObject.GetById - исп. устаревщий конструктор (удалите) для GroudType, который не 
устанвливает  watercapacity (капилярная влагоемкость и наверное еще чего) всегда устанавливается значение -1
-----------------------------------------------------------------------------------------------------
smw60-09.11.2016-DaryaCherniak,Nadeghda:  Техноген. Об - перепутали область и р-н, съехали кооржинаты, нижнее меню
--------------------------------------------------------------------------------------------------
adeln-09.11.2016 - Отчет. Дополнены таблицы, добавлены размерности. Изменения выд. цветом
---------------------------------------------------------------------------------------------------------------
AzarkevichO-09.11.2016 - smw60, я исправляю коэффициент растекания
                         Сколько знаков после запятой должно выводить в Диапазоне гидравлического уклона? 
-----------------------------------------------------------------------------------------------------------------
smw60-08.11.2016-Adeln,DaryaCherniak: грунты, там все безразмерное?
---------------------------------------------------------------------------------------------------------------
smw60-08.11.2016-Adeln, AzarkevichO: хим. состав нефтей - коэф. дифузии сполз, побольше места для названия   
---------------------------------------------------------------------------------------------
smw60-08.11.2016-Adeln,BlinovaE, AzarkevichO: кто исправляет коэффициент растекания?! 
-------------------------------------------------------------------------
adeln-08.11.2016-smw60: Отчет.GroundBlue, формулыV9, приер_раачета1
-------------------------------------------------------------------------
smw60-08.11.2016-Adeln,BlinovaE, DaryaCherniak: рухнул коэффициент растекания 
----------------------------------------------------------------------------------------
smw60-08.11.2016-Adeln,DaryaCherniak: Опорные точки: создание - съехало нижнее меню, удалить - покажите идентификатор
и координаты
-----------------------------------------------------------------------------------
