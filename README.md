# EGH
DaryaCherniak-06.11.201-Adeln почему тип объекта не изменяемое поле? А если при заполнении формы я ошиблась в типе? Целая новая форма при ошибки? Для электронной почты не подготовленно место. 
-------------------------------------------------------------------------------
