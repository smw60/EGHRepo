# EGH
DaryaCherniak-06.11.201-Adeln 1.почему тип объекта не изменяемое поле? А если при заполнении формы я ошиблась в типе? 2.Целая новая форма при ошибке? 3.Для электронной почты не подготовлено место. Какие должны быть диапазоны дат? Там поле date (пока оно только в создании объекта, скоро появится и в изменении), оно само по себе не даёт ввести не корректную дату.
-------------------------------------------------------------------------------
