# EGH
-----------------------------------------------
DaryaCherniak-06.11.2016-smw60: Все ваши замечания были исправлены, кроме того, что при выводе секунд, выводится большое количество знаков после запятой. Не получается с этим справится. И будет ли сегодня форма для опорных точек?
-----------------------------------------------
